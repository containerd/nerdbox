...
func addResolvConf(ctx context.Context, b *bundle.Bundle, fallbackToHostRC bool, podDNS *types.CRIDNSConfig) error {
...
func formatPodDNSConfig(dns *types.CRIDNSConfig) string {
