...
func TestParseCTag(t *testing.T) {
	cases := []struct {
		...
		{"plain", "krun_create_ctx", "krun_create_ctx", false},
		{"optional", "krun_add_virtiofs3,optional", "krun_add_virtiofs3", true},
		{"optional_with_unknown_tail", "krun_foo,optional,bogus", "krun_foo", true},
		{"unknown_tail_only", "krun_foo,bogus", "krun_foo", false},
		{"empty", "", "", false},
	}
	for _, c := range cases {
